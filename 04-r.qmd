...
La función [read.csv()](https://rdrr.io/r/utils/read.table.html) permite leer datos de un archivo de valores separados por comas (CSV), el cual puede estar en una ubicación local o remota.
...
#### Descripción general
[Tidyverse](https://www.tidyverse.org/) es una colección de paquetes de R enfocados en ciencia de datos, una discipina que permite convertir datos no procesados en entendimiento, comprensión y conocimiento.
